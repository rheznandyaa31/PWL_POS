...
class SupplierController extends Controller
{
    ...
    //Ambil data supplier dalam bentuk json untuk datables
    ...
    public function update(Request $request, String $id) {
        $request->validate([
            // supplier_kode harus diisi, berupa string, minimal 3 karakter, dan bernilai unik di tabel m_supplier kolom supplier_kode kecuali untuk supplier dengan id yang sedang diedit
    ...
    // Menampilkan detail supplier ajax
    ...
    // Menampilkan hapus data supplier ajax
